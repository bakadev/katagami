...
/**
 * Sign in, option A: a centered stencil sheet.
 *
 * One notched card on the asanoha ground, the wordmark on top, GitHub and
 * Google as outlined notched buttons, one line saying why an account
 * exists at all, and a way back to a document without one. There is no
 * email and password, so signing in with a provider is also signing up.
 */
...
export default function SignInA() {
  ...
  return (
    ...
    >
      <ExplorationBar round="auth" current="signin-a" />
      ...
      <main className="relative">
        ...
        <div className="relative mx-auto max-w-md px-6 pb-24 pt-14 sm:pt-20">
          <div className="relative">
            ...
            >
              ...
              <h1 style={{ fontFamily: SERIF }} className="mt-8 text-3xl leading-tight">
                Sign in
              </h1>
              ...
              <p className="mt-3 text-xs text-muted-foreground">
                No password. Signing in with a provider for the first time creates your account.
              </p>
...
/** Outlined notched button: indigo outer face, card inner face. */
...
function StencilMark() {
  return (
    <svg
      aria-hidden
      viewBox="0 0 24 24"
      className="size-5 text-[var(--indigo)] dark:text-blue-300"
      fill="none"
      stroke="currentColor"
      strokeWidth="1.25"
    >
