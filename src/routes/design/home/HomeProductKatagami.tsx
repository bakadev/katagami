...
/**
 * Homepage option C — Product / Business user, katagami iteration.
 *
 * Same persona, sections, copy and layout as HomeProduct. What changes is
...
export default function HomeProductKatagami() {
  ...
  return (
    ...
    >
      <ExplorationBar round="home" current="katagami" />
